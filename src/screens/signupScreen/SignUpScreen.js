...
const Sigup = ({ navigation }) => {
    ...
    return (
        ...
        onChangeText={(text) => setMobileNumber(text)}
            ...
            <Text style={styles.informationText} onPress={()=> navigation.navigate('CustomizeProfile')}>Al registrarte aceptas nuestros <Text style={{ color: '#408639' }}>términos y condiciones</Text></Text>
